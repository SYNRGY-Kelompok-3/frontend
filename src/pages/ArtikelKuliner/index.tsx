...
function ArtikelKuliner() {
  const breadcrumbSteps = [{ text: "Artikel", link: "/artikel" }, { text: "Kuliner" }];
        ...
        <article>
          ...
          <div className="flex flex-wrap justify-around w-full gap-6 sm:gap-x-8">
            ...
            <div className="flex-[1] rounded-lg flex flex-col">
              {kuliner.map(({ id, title, category, content, image_url, updated_at }) => {
                return (
                  <div key={id}>
                    <Figure
                      src={image_url}
