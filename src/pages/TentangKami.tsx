...
const TentangKami = () => {
  ...
  return (
    <>
      ...
      <main className="mx-4 mt-5 md:mx-8 lg:mx-28">
          ...
          <article className="mt-8 mb-10 md:mt-10">
            ...
            <div className="mt-3 text-base text-justify">
              <ul className="flex flex-col p-0 m-0 list-none">
                ...
                <li className="flex items-start mb-3 text-gray-500">
                  <span className="mr-2 text-blue-700">&#8226;</span> Menjadi perusahaan tours & travel online
                  terbaik di Indonesia dengan selalu memberikan kepuasan pelayanan dan manfaat kepada
                  konsumen.
                </li>
              </ul>
            </div>
