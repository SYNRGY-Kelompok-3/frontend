...
function Riwayat() {
  ...
  return (
    <>
      <div className="w-auto sm:w-full flex flex-col justify-between p-5 sm:p-8 border-2 rounded-lg mt-4 ml-4 mr-4 sm:mr-0">
        <div>
          ...
          <div className="overflow-y-auto h-screen my-5 sm:h-[770px]">
            ...
            <details className="group mt-5" open>
              ...
              <div className="mt-5 flex justify-between items-center">
                <div className="flex flex-col gap-5">
                  <div className="text-slate-500 text-sm sm:text-lg">Bank Pembayaran</div>
                  <div className="text-slate-500 text-sm sm:text-lg">Nama Rekening</div>
                  <div className="text-slate-500 text-sm sm:text-lg">Nomor Rekening</div>
                </div>
                <div className="flex flex-col gap-5">
                  <div className="font-bold flex justify-end text-sm sm:text-lg">
                    {booking?.bankPembayaran}
                  </div>
                  <div className="font-bold flex justify-end text-sm sm:text-lg">{booking?.namaRekening}</div>
                  <div className="font-bold flex justify-end text-sm sm:text-lg">
                    s{booking?.nomorRekening}
                  </div>
                </div>
              </div>
            </details>
            <details className="group mt-5" open>
              ...
              <div className="mt-5 flex justify-between items-center">
                <div className="flex flex-col gap-5">
                  <div className="text-slate-500 text-sm sm:text-lg">Nama Lengkap</div>
                  <div className="text-slate-500 text-sm sm:text-lg">No. Telepon</div>
                  <div className="text-slate-500 text-sm sm:text-lg">Email</div>
                </div>
                <div className="flex flex-col gap-5">
                  <div className="font-bold flex justify-end text-sm sm:text-lg">
                    Tn/Ms. {booking?.customer.name}
                  </div>
                  <div className="font-bold flex justify-end text-sm sm:text-lg">
                    {booking?.customer.phoneNumber}
                  </div>
                  <div className="font-bold flex justify-end text-sm sm:text-lg">
                    s{booking?.customer.email}
                  </div>
                </div>
              </div>
            </details>
            <details className="group mt-5" open>
              ...
              {bookingDetail.map((bookingDetail, index) => (
                <div
                  key={index}
                  className="mt-3 p-2 rounded-lg bg-blue-300 text-blue-500 font-bold text-sm sm:text-lg"
                >
        ...
        <div>
          <Button
            content={"Cetak E-Ticket"}
            className={"w-full rounded-lg text-white text-xl py-3 bg-blue-500"}
          />
        </div>
      </div>
    </>
