        ...
        <ul>
          <li>
            <NavLink
              ...
              className={({ isActive }): string =>
                `flex items-center ${
                  isActive
                    ? "pl-2 font-bold text-blue-500 bg-blue-100 py-5 border-l-4 border-blue-500 rounded-tr-xl rounded-br-xl"
                    : "text-black py-5"
                }`
              }
            >
          ...
          <li>
            ...
            >
              ...
              <span className="ml-2 text-lg">Notifikasi</span>
            </NavLink>
          </li>
          <li>
            <NavLink
            ...
            >
              ...
              <span className="ml-2 text-lg">Riwayat Transaksi</span>
            </NavLink>
          </li>
          <li>
            <div
            ...
            >
              ...
              <span className="ml-2 text-lg">Keluar</span>
            </div>
          </li>
        </ul>
      </aside>
