              ...
              >
                <button
                  className={`w-8 h-8 flex items-center justify-center border-2 rounded-full ${
                    step.isActive ? 'border-blue-500 text-blue-500 bg-white' : 'border-green-500 text-green-500 bg-white'
                  }`}
                  disabled={!step.isActive}
                >
                  {step.isActive ? (
                ...
                <span className={`text-sm ml-2 ${step.isActive ? 'font-semibold text-white' : 'font-normal text-white'}`}>
                  {step.text}
                </span>
              </button>
            </>
